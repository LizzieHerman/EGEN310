...
seesaw_Servo right(&crickit); // right servo rotation reversed
    ...
    if (pressed) {
      switch(buttnum){
        case 5: //up
          ...
          if(velocity >= 10){ // check if the car is at top speed
          ...
          } else if(leftvel >= 180 || rightvel  <= 0){ // check if either left or right motor is at top speed
            ...
            if(rightvel < 0){ // check if the increase was too much
            ...
            if(leftvel == 90 || rightvel == 90||(leftvel < 90 && rightvel < 90)||(leftvel > 90 && rightvel > 90)){ // this means that there is no forward/ backward momentum
              ...
              velocity = (((leftvel + (180 - rightvel)) / 2.0) - 90) / 9;
            }
            left.write(leftvel);
        ...
        case 6: //down
          ...
          if((velocity) <= -10){ // check if the car is at top reverse speed
          ...
          } else if(leftvel <= 0 || rightvel >= 180){ // check if either left or right motor is at reverse speed
            Serial.println("Car cannot increase speed without changing turning radius");
          } else {
            ...
            if(rightvel > 180){ // check if the decrease was too much
        ...
        case 7: //left
          ...
          angle = ((90 - rightvel) - (leftvel - 90)) / 9.0;
          left.write(leftvel);
          right.write(rightvel);
          Serial.print("Velocity now "); Serial.println(velocity, 2);
        ...
        case 2: //2
          ...
          if(velocity > 10) velocity = 10;
          leftvel = roundf((velocity * 9) + 90);
          rightvel = (180 - leftvel);
          velocity = (leftvel - 90) / 9.0;
          left.write(leftvel);
          right.write(rightvel);
